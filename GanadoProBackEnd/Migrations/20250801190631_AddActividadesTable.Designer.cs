...
namespace GanadoProBackEnd.Migrations
{
    ...
    [Migration("20250801190631_AddActividadesTable")]
    partial class AddActividadesTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GanadoProBackEnd.Models.Actividad", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GanadoProBackEnd.Models.Lote", b =>
                {
                    ...
                    b.Property<DateTime>("Fecha_Creacion")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2025, 8, 1, 19, 6, 30, 325, DateTimeKind.Utc).AddTicks(6921));
            ...
            modelBuilder.Entity("GanadoProBackEnd.Models.Venta", b =>
                {
                    ...
                    b.Property<int?>("RanchoOrigenId_Rancho")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("RanchoOrigenId_Rancho");
            ...
            modelBuilder.Entity("GanadoProBackEnd.Models.Actividad", b =>
                {
                    b.HasOne("GanadoProBackEnd.Models.User", "Usuario")
                        .WithMany()
            ...
            modelBuilder.Entity("GanadoProBackEnd.Models.Venta", b =>
                {
                    ...
                    b.HasOne("GanadoProBackEnd.Models.Rancho", "RanchoOrigen")
                        .WithMany()
                        .HasForeignKey("RanchoOrigenId_Rancho");
