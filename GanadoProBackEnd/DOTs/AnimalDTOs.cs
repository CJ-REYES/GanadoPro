...
namespace GanadoProBackEnd.DTOs
{
    public class AnimalResponseDto
    {
        ...
        public string Categoria { get; set; } = null!; // <-- Nueva propiedad
        public string Raza { get; set; } = null!;
        public int Edad_Meses { get; set; }             // <-- Nueva propiedad
        public DateTime Fecha_Registro { get; set; }    // <-- Nueva propiedad
